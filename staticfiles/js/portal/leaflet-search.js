...
! function (a) {
    ...
    return a.Control.Search = a.Control.extend({
        ...
        _createInput: function (b, c) {
            ...
            }, this).on(f, "blur", this.collapseDelayed, this).on(f, "focus", this.collapseDelayedStop, this), f
        },
        ...
        showTooltip: function (a) {
            if (this._countertips = 0, this._tooltip.innerHTML = "", this._tooltip.currentSelection = -1, this.options.tooltipLimit)
                for (var b in a) {
                    ...
                    this._countertips++, this._tooltip.appendChild(this._createTip(b, a[b]))
                }
        ...
        _defaultFormatData: function (b) {
            var c, d = this,
                ...
                g = {};
            if (a.Util.isArray(f))
                for (c in b) g[d._getPath(b[c], e)] = a.latLng(b[c][f[0]], b[c][f[1]]);
            else
        ...
        _fillRecordsCache: function () {
            ...
            this._curReq && this._curReq.abort && this._curReq.abort(), a.DomUtil.addClass(this._container, "search-load"), this.options.layer ? (this._recordsCache = this._recordsFromLayer(), b = this._filterData(this._input.value, this._recordsCache), this.showTooltip(b), a.DomUtil.removeClass(this._container, "search-load")) : (this.options.sourceData ? this._retrieveData = this.options.sourceData : this.options.url && (this._retrieveData = this.options.jsonpParam ? this._recordsFromJsonp : this._recordsFromAjax), this._curReq = this._retrieveData.call(this, d, function (d) {
                c._recordsCache = c._formatData.call(c, d), b = c.options.sourceData ? c._filterData(c._input.value, c._recordsCache) : c._recordsCache, c.showTooltip(b), a.DomUtil.removeClass(c._container, "search-load")
            }))
        },
